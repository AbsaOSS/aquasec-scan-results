...
# get_dev_branch_comparison


def test_get_dev_branch_comparison_returns_true(mocker):
    mocker.patch("src.action_inputs.get_action_input", return_value="true")

    actual = ActionInputs.get_dev_branch_comparison()

    assert actual is True


def test_get_dev_branch_comparison_returns_false(mocker):
    mocker.patch("src.action_inputs.get_action_input", return_value="false")
